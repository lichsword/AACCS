package com.kakashi.reader.database;
...
import com.kakashi.reader.model.Item;
import com.kakashi.reader.model.Subscription;
import com.kakashi.reader.model.Tag;
import com.kakashi.reader.model.Tag2Item;
import com.kakashi.reader.model.Tag2Sub;
...
public class ReaderProvider extends ContentProvider {
	...
	public static final String BEGIN_TXN_URI_NAME = "content://" + AUTHORITY
			+ "/begin_txn";
	public static final String SUCCESS_TXN_URI_NAME = "content://" + AUTHORITY
			+ "/success_txn";
	public static final String END_TXN_URI_NAME = "content://" + AUTHORITY
			+ "/end_txn";
	public static final String SUB_CONTENT_URI_NAME = "content://" + AUTHORITY
			+ "/" + Subscription.TABLE_NAME;
	public static final String TAG_CONTENT_URI_NAME = "content://" + AUTHORITY
			+ "/" + Tag.TABLE_NAME;
	public static final String TAG2SUB_CONTENT_URI_NAME = "content://"
			+ AUTHORITY + "/" + Tag2Sub.TABLE_NAME;
	public static final String ITEM_CONTENT_URI_NAME = "content://" + AUTHORITY
			+ "/" + Item.TABLE_NAME;
	public static final String TAG2ITEM_CONTENT_URI_NAME = "content://"
			+ AUTHORITY + "/" + Tag2Item.TABLE_NAME;
	public static final String UPDATE_UNREADS_CONTENT_URI_NAME = "content://"
			+ AUTHORITY + "/update_unreads";
	...
	public static final Uri URI_UPDATE_UNREADS = Uri
			.parse(UPDATE_UNREADS_CONTENT_URI_NAME);
	...
	private static final String[] SQL_UPDATE_UNREADS = {
			...
			"update tag set unread_count = (select ifnull(sum(s.unread_count), 0) from subscription s, tag2sub t2s where s._id = t2s.sub_id and tag.uid = t2s.tag_uid) where tag.type = "
					+ Tag.TYPE_FOLDER,
			"update tag set unread_count = (select ifnull(count(i._id), 0) from item i, tag2item t2i where i._id = t2i.item_id and tag.uid = t2i.tag_uid and i.read = 0) where tag.type <> "
					+ Tag.TYPE_FOLDER };
	...
	static {
		...
		uriMatcher
				.addURI(AUTHORITY, Tag2Item.TABLE_NAME + "/#", UM_TAG2ITEM_ID);
		uriMatcher.addURI(AUTHORITY, Tag2Item.TABLE_NAME, UM_TAG2ITEMS);
		uriMatcher.addURI(AUTHORITY, "update_unreads", UM_UPDATE_UNREADS);
	}

	public static String sqlCreateIndex(String tableName, String[] columnNames) {
