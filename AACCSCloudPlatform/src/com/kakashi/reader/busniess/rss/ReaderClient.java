...
public abstract class ReaderClient {
	 ...
	 private static final String TAG = ReaderClient.class.getSimpleName();
	    ...
	    public ReaderClient(Context context) {
	        ...
	        this.client = ReaderUtil.createHttpClient();
	    ...
	    /**
	     * Get loginId(gmail) & password from preference xml and then login. 
	     * @return
	     * @throws IOException
