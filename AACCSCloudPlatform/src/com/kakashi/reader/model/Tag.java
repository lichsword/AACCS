...
public class Tag implements Serializable, BaseColumns {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -593031282935389932L;
	...
	public static final Uri CONTENT_URI = Uri
			.parse(ReaderProvider.TAG_CONTENT_URI_NAME);
	...
	public static final String[] DEFAULT_SELECT = { _ID, _UID, _SORTID, _LABEL,
			_SYNC_TIME };
	...
	public static final String SQL_CREATE_TABLE = "create table if not exists "
			...
			+ " text not null," + _TYPE + " integer not null," + _SORTID
			+ " text not null," + _LABEL + " text not null," + _UNREAD_COUNT
			+ " integer not null default 0," + _SYNC_TIME
			+ " integer not null default 0" + ")";

	public static final String[][] INDEX_COLUMNS = { { _UID }, { _TYPE },
			{ _SORTID }, { _SYNC_TIME } };
	...
	public ContentValues toContentValues() {
		...
		/*
		 * values.put(_UNREAD_COUNT, this.unreadCount); values.put(_SYNC_TIME,
		 * this.syncTime);
		 */
		return values;
	}
