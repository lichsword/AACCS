...
public class GetOpenFileNameAdapter extends BaseAdapter {

	@SuppressWarnings("unused")
	private final String TAG = GetOpenFileNameAdapter.class.getSimpleName();

	private File[] mFileList = null;

	public GetOpenFileNameAdapter(Context context, File[] fileList) {
		super();
		mFileList = fileList;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (null == convertView) {
			convertView = mInflater.inflate(R.layout.list_item_open_file_name,
					null);
		}// end if
		...
		if (null == viewHolder) {
			...
			viewHolder.mIconImageView = (ImageView) convertView
					.findViewById(R.id.iconFileImageView);
